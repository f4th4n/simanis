...
class Pengajuan extends BaseController {
	public function index() {
		...
		return view('pengecek/pengajuan/index', $data);
	}
	...
	public function view($id) {
		...
		return view('pengecek/pengajuan/view', $data);
	}
	...
	public function create() {
		...
		return view('pengecek/pengajuan/create', $data);
	}
	...
	public function save($id = null) {
		...
		$is_new = $id === null;
		$failed_redirect_to = $is_new ? '/admin/pengecek/pengajuan/create' : '/admin/pengecek/pengajuan/' . $id;
		$succed_redirect_to = $is_new ? '/admin/pengecek/pengajuan' : '/admin/pengecek/pengajuan/' . $id;
